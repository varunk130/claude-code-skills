---
name: ai-stakeholder-translator
...
### Step 1: Intake & Core Message Extraction
1. Core fact (1 sentence)
2. Impact magnitude
3. Timeline
4. Key metrics (business vs technical)
5. Risk/sensitivity scan

### Step 2: Sensitivity Classification
- All audiences: shipped features, public benchmarks
- Internal only: timelines, resource constraints, internal metrics
- Restricted: unreleased roadmap dates, revenue numbers
...
- Each uses vocabulary appropriate to its audience
- No restricted content leaked into customer or sales outputs
- Executive summary under 150 words
- Board narrative connects to a strategic theme
- Customer changelog has zero internal jargon
- Sales brief has at least 2 objection-handling pairs
